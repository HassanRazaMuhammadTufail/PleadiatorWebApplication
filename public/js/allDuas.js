...
function render(duaObj){
    ...
    duaColumn.setAttribute("class", "col-md-7 d-block my-3");

    var duaCard = document.createElement("DIV");
    duaCard.setAttribute("class", "card card-success card-form ");
    ...
    likeBtn.setAttribute("class", "btn btn-primary d-inline-block");
    ...
    commentBtn.setAttribute("class", "btn btn-secondary ml-2");
    ...
    firebase.database().ref('/likeStatus/' + userID + "/" + duaObj.id).on('value', function(snapshot) {
        ...
        if(obj.likeStatus === true){
            ...
            unlikeBtn.setAttribute("class", "btn btn-primary d-inline-block");
        }
        else{
            likeBtn.setAttribute("class", "btn btn-primary d-inline-block");
            unlikeBtn.setAttribute("class", "d-none");
